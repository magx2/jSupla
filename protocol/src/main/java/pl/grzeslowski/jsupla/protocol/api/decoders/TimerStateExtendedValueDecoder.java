...
public class TimerStateExtendedValueDecoder implements pl.grzeslowski.jsupla.protocol.api.decoders.ProtoWithSizeDecoder<TimerStateExtendedValue> {
    public static final TimerStateExtendedValueDecoder INSTANCE = new TimerStateExtendedValueDecoder();
    ...
    public TimerStateExtendedValue decode(byte[] bytes, int offset) {
        ...
        byte[] senderName = PrimitiveDecoder.INSTANCE.copyOfRangeByte(bytes, offset, (offset + SUPLA_SENDER_NAME_MAXSIZE));
