...
public class ChannelConfigHVACEncoder implements ProtoWithSizeEncoder<ChannelConfigHVAC> {
    ...
    public byte[] encode(ChannelConfigHVAC proto, byte[] bytes, int offset) {
        ...
        if (proto.binarySensorChannelId() != null) {
            ...
            PrimitiveEncoder.INSTANCE.writeUnsignedByte(
                    proto.binarySensorChannelNo(), bytes, offset);
        } else {
        ...
        offset +=
                PrimitiveEncoder.INSTANCE.writeUnsignedShort(proto.usedAlgorithm(), bytes, offset);
        ...
        } else if (proto.masterThermostatIsSet() != null
                && proto.masterThermostatChannelNo() != null) {
            int add =
                    PrimitiveEncoder.INSTANCE.writeUnsignedByte(
