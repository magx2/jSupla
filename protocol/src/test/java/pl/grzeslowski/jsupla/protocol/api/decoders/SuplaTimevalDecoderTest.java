...
class SuplaTimevalDecoderTest {
    ...
    void zamel() {
        ...
        var tvSec =
                67305985L; // PrimitiveDecoder.INSTANCE.parseLong(new byte[]{1, 2, 3, 4, 0, 0, 0,
        // 0}, 0)
        var tvUsec =
                134678021L; // PrimitiveDecoder.INSTANCE.parseLong(new byte[]{5, 6, 7, 8, 0, 0, 0,
        // 0}, 0)
    ...
    void auraton() {
        ...
        // byte[]{110,50,46,103,0,0,0,0}, 0)
        var tvUsec =
                904585L; // PrimitiveDecoder.INSTANCE.parseLong(new byte[]{-119,-51,13,0,0,0,0,0},
        // 0)
