...
public class SuplaSetActivityTimeoutResultRandomizer
        implements Randomizer<SuplaSetActivityTimeoutResult> {
    ...
    public SuplaSetActivityTimeoutResult getRandomValue() {
        ...
        return new SuplaSetActivityTimeoutResult(randomSupla.nextUnsignedByte(), min, max);
    }
}
