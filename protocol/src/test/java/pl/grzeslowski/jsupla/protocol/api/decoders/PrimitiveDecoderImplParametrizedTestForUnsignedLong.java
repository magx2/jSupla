...
public class PrimitiveDecoderImplParametrizedTestForUnsignedLong {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
            ...
            {new byte[]{-1, -1, -1, -1, 0, 0, 0, 0}, 0, new BigInteger(UNSIGNED_INT_MAX + "")},
            {new byte[]{-1, -1, -1, -1, -1, -1, -1, -1}, 0, UNSIGNED_LONG_MAX}, // max value of ulong
            {new byte[]{15, 85, -16, -86, 0, 0, 0, 0}, 0, new BigInteger("2867877135")}, // 10101010 11110000 01010101 00001111
            {new byte[]{-86, -16, 85, 15, 0, 0, 0, 0}, 0, new BigInteger("257290410")}, // 00001111 01010101 11110000 10101010
            {new byte[]{1, 2, 3, 4, 15, 85, -16, -86, 0, 0, 0, 0}, 4, new BigInteger("2867877135")},// offset 10101010 11110000 01010101 00001111
            {new byte[]{-5, -6, -7, -86, -16, 85, 15, 0, 0, 0, 0}, 3, new BigInteger("257290410")}, // offset 00001111 01010101 11110000 10101010
        });
    }

    public PrimitiveDecoderImplParametrizedTestForUnsignedLong(byte[] intBytes, int offset,
                                                               BigInteger ulong) {
