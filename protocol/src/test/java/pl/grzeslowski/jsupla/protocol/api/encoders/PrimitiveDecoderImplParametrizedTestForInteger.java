...
public class PrimitiveDecoderImplParametrizedTestForInteger {
    ...
    public PrimitiveDecoderImplParametrizedTestForInteger(
            final byte[] intBytes, final int offset, final int intValue) {
