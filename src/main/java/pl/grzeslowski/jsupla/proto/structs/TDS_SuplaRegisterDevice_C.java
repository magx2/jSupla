...
public final class TDS_SuplaRegisterDevice_C implements Proto {
    ...
    public int size() {
        ...
        return BYTE_SIZE + INT_SIZE + SUPLA_LOCATION_PWD_MAXSIZE + SUPLA_GUID_SIZE + SUPLA_DEVICE_NAME_MAXSIZE + SUPLA_SOFTVER_MAXSIZE + SUPLA_SERVER_NAME_MAXSIZE + channels[0].size() * SUPLA_CHANNELMAXCOUNT;
    }
